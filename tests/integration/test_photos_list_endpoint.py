"""
Integration test for GET /photos list endpoint.

Moved from E2E: This test uses FastAPI TestClient and seeds the DB directly, so it is not a true end-to-end test.
"""
...
def test_photos_list_integration(client):
